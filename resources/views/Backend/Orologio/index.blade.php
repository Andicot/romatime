...
@section('toolbar')
    <div class="d-flex align-items-center">
        ...
        <a class="btn btn-sm btn-warning fw-bold me-2" href="{{action([$controller,'index'],['stato'=>'in_carico'])}}">In Carico</a>
        <a class="btn btn-sm btn-info fw-bold me-2" href="{{action([$controller,'index'],['stato'=>'conto_vendita'])}}">Conto Vendita</a>
        <a class="btn btn-sm btn-success fw-bold me-2" href="{{action([$controller,'index'],['stato'=>'venduti'])}}">Venduti</a>
...
@section('content')
    <div class="card pt-4">
        <div class="card-body pt-0 pb-5 fs-6 px-2 px-md-6" id="tabella">
            @include('Backend.Orologio.tabella')
        </div>
    </div>
@endsection
@push('customScript')
