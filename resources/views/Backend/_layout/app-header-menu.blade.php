...
>
    ...
    <div class="menu-item">
        <a class="menu-link "
           href="{{action([\App\Http\Controllers\Backend\OrologioController::class,'index'])}}">
    ...
    <div data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="bottom-start"
        ...
        <div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown px-lg-2 py-lg-4 w-lg-250px">
            ...
            <div class="menu-item">
                <div class="menu-item">
                    <a class="menu-link" href="{{action([\App\Http\Controllers\Backend\MarcaController::class,'index'])}}">
