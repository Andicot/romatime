...
@section('content')
    ...
    @includeWhen(session()->has('message'),'Backend._components.alertMessage')
    <div class="card">
        <div class="card-body">
            ...
            <ul class="nav nav-tabs nav-line-tabs nav-line-tabs-2x mb-5 fs-6">
                <li class="nav-item">
                    <a class="nav-link active" data-bs-toggle="tab" href="#tab_dati">Dati utente</a>
                </li>
                <li class="nav-item">
            ...
            <div class="tab-content" id="myTabContent">
                <div class="tab-pane fade active show" id="tab_dati" role="tabpanel">
                    <div class="row">
                        <div class="col-lg-8 px-lg-2 py-lg-2">
                            ...
                            <form method="POST" action="{{ action([$controller,'update'],'dati-utente') }}" enctype="multipart/form-data">
                                ...
                                @include('Backend._inputs.inputText',['campo'=>'cognome','placeholder'=>'Il tuo cognome','required'=>true,'autocomplete'=>'family-name'])
                                @include('Backend._inputs.inputText',['campo'=>'nome','placeholder'=>'Il tuo nome','required'=>true,'autocomplete'=>'given-name'])
                                @include('Backend._inputs.inputText',['campo'=>'telefono','placeholder'=>'Il tuo numero di telefono','required'=>false,'altro'=>'maxlength="16"'])
                ...
                <div class="tab-pane fade" id="tab_password" role="tabpanel">
                    <div class="row">
                        <div class="col-lg-8 px-lg-2 py-lg-2">
                    ...
                    <div class="row">
                        <div class="col-lg-8 px-lg-2 py-lg-2">
                            ...
                            <form method="POST" action="{{ action([$controller,'update'],'dati-email') }}">
                                @csrf
                                @method('PATCH')
                                @include('Backend._inputs.inputText',['campo'=>'email','placeholder'=>'Il tuo indirizzo email','required'=>true,'autocomplete'=>'email'])
                                <div class="w-100 text-center">
